(function() {
  ...
  _.defaults = function(objectToExtend) {
    ...
    _.each(args, function (object) {
      _.each(object, function (value, key) {
        ...
        if (!contains) objectToExtend[key] = value;
      });
    });
    return objectToExtend;
  };
  ...
  _.shuffle = function(array) {
    ...
    var tempValue;
    var randomIndex;
    var currentIndex = dupArray.length;

    while (currentIndex) {
      randomIndex = Math.floor(Math.random() * currentIndex);
      currentIndex--;

      tempValue = dupArray[currentIndex];
      dupArray[currentIndex] = dupArray[randomIndex];
      dupArray[randomIndex] = tempValue;
    }
    return dupArray;
  };
  ...
  _.difference = function(array) {
    ...
    _.each(array0, function(item){
      var any = _.some(args, function(array) {
        return _.contains(array, item);
      });
      if (!any) results.push(item);
    });
    return results;
  };
